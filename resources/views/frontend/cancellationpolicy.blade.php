...
@section('title', 'cancellation-policy - Jawai Leopard Safari')
@section('content')
<!-- ======= Breadcrumbs ======= -->
      ...
      <div class="row g-4">
         <div class="col-md-12">
            <ul class="list p-design" style="--gap: 2rem">
               ...
               <li>
                  <div class="zoo-box">
                     <h5 class="mt-0">Use of Website</h5>
                     <ul class="list list--base" style="--gap: 0.5rem">
                        <li>You agree to use this website for lawful purposes only. Any misuse, including unauthorized access or interference with our services, is prohibited.</li>
                        <li>All content, including text, images, and logos, is owned or licensed by Wildlife Safari Tourism and protected by copyright laws. Unauthorized use is prohibited.</li>
                     </ul>
                  </div>
               </li>
               <li>
