@extends('layouts.vertical', ['title' => 'Transportation Vehicles'])
@section('css')
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title">Transportation Vehicles</h4>
                    </div>
                    <div class="col-auto">
                        <a href="{{ route('backend.transportation.vehicle.create') }}" type="button" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Create</a>
                    </div>
                    <!--end col-->
                </div>
                <!--end row-->
        ...
        const handleDelete = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('backend.transportation.vehicle.destroy', 'refId') }}".replace('refId', id),
                        method: "POST",
                        data: {
                            _method: 'DELETE'
                        },
